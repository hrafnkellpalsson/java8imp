...
public class HttpClient {
  ...
  /**
   * Callbacks are possible! ...but nested callbacks will of course be horrible :/ See example in
   * chapter 'A Naive Approach' here https://jersey.java.net/documentation/latest/rx-client.html
  ...
  /**
   * This is not as exiting as I thought it was. The whole response is read at once in a blocking
