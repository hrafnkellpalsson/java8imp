...
public class ClassStuffTest {
    @Test
    public void testStuff() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        Class<?> d0 = ClassLoader.getSystemClassLoader().loadClass(fqn); // Type erasure forces a wildcard return type
